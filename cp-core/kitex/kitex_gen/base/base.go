...
func (p *EmptyBody) InitDefault() {
}

var fieldIDToName_EmptyBody = map[int16]string{}

func (p *EmptyBody) Read(iprot thrift.TProtocol) (err error) {
...
func (p *EmptyBody) Write(oprot thrift.TProtocol) (err error) {

	if err = oprot.WriteStructBegin("EmptyBody"); err != nil {
		goto WriteStructBeginError
	}
	if p != nil {
	}
...
func (p *EmptyBody) String() string {
	if p == nil {
		return "<nil>"
	}
	return fmt.Sprintf("EmptyBody(%+v)", *p)

}

func (p *EmptyBody) DeepEqual(ano *EmptyBody) bool {
	if p == ano {
		return true
	} else if p == nil || ano == nil {
		return false
