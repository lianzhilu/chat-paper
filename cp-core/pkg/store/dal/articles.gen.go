...
func newArticle(db *gorm.DB, opts ...gen.DOOption) article {
	...
	_article.SID = field.NewString(tableName, "sid")
	_article.AuthorID = field.NewString(tableName, "author_id")
	...
	_article.ViewCount = field.NewUint64(tableName, "view_count")
	_article.LikeCount = field.NewUint64(tableName, "like_count")
	_article.CommentCount = field.NewUint64(tableName, "comment_count")
	_article.CreateTime = field.NewTime(tableName, "create_time")
	_article.UpdateTime = field.NewTime(tableName, "update_time")
	_article.DeleteTime = field.NewUint(tableName, "delete_time")
...
type article struct {
	...
	ViewCount    field.Uint64
	LikeCount    field.Uint64
	CommentCount field.Uint64
...
func (a *article) updateTableName(table string) *article {
	...
	a.AuthorID = field.NewString(table, "author_id")
	a.Title = field.NewString(table, "title")
	a.Status = field.NewString(table, "status")
	a.Content = field.NewString(table, "content")
	a.ViewCount = field.NewUint64(table, "view_count")
	a.LikeCount = field.NewUint64(table, "like_count")
	a.CommentCount = field.NewUint64(table, "comment_count")
	a.CreateTime = field.NewTime(table, "create_time")
	a.UpdateTime = field.NewTime(table, "update_time")
	a.DeleteTime = field.NewUint(table, "delete_time")
